...
@registry.register_task("minicoco_captioning")
class MinicocoCaptionTask(BaseTask):
    ...
    def _report_metrics(self, eval_result_file, split_name):
        ...
        gt_root = '/teams/ai_model_1667305326/WujieAITeam/private/jyd/dataset/minicoco/all/test_cache.json'
